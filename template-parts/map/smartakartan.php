...
<div class="map-container map-container-solo">
	<!-- Show the map -->
    ...
    <div id="full-map-nav">
      ...
      <div id="checkwrap-open">
           <label>
             <span class="inner-label"><?php pll_e( 'Öppet nu');?></span>
              <input id="checkboxOpen" name="open" class="sub-check" type="checkbox"  value="open" ><div><div></div></div>
           </label>
      </div>
...
<script>
  var array = <?php echo json_encode($allPostsArray)?>;
</script>
